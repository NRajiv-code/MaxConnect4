 ...
 *         To compile the program, use the following command from the
 ...
 *         java MaxConnectFour interactive [ input_file ] [ computer-next /
 *         human-next ] [ search depth]
 *
 *         -- for one move mode
 *         java maxConnectFour.MaxConnectFour one-move [ input_file ] [
 ...
 *         -- the entity to make the next move. either computer or human. can be
 *         abbreviated to either C or H. This is only used in interactive mode
 * 
 *         [ output_file ]
 *         -- the path and filename of the output file for the game. this is
 *         only used in one-move mode
 * 
 *         [ search depth ]
